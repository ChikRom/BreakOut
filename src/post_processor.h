...
// specific effects by enabling either the Confuse, Chaos or Shake boolean.
// It is required to call Begin Render() before rendering the game
...
private:
	...
	unsigned int RBO; // RBO is used for multisampled colour buffer
	unsigned int VAO;
